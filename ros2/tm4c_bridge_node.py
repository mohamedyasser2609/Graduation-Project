[6/30/26 3:12 PM] Habiba Yasser EA: project_ws/src/uart_comstack/uart_comstack/tm4c_bridge.py
#!/usr/bin/env python3
...
TM4C_USB_PORT = '/dev/serial/by-id/usb-Texas_Instruments_In-Circuit_Debug_Interface_0E23AD25-if00'

class TM4CBridgeNode(Node):

    def init(self):
        super().init('tm4c_bridge')
...
[6/30/26 3:12 PM] Habiba Yasser EA: # ==========================
    # OUTGOING: VELOCITY
    # ==========================
...
[6/30/26 3:12 PM] Habiba Yasser EA: # Convert scaled ints back to real values (x100)
